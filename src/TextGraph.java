...
public class TextGraph {
    ...
    public String queryBridgeWords(String word1, String word2) {
        if (!graph.containsKey(word1) || !graph.containsKey(word2))
        {
            ...
            else return "No \"" + word2 + "\" in the graph!";
        }
        ...
        if (bridgeWords.isEmpty()) {
            ...
            String result;
            if(bridgeWords.size()>1)result = "The bridge words from \"" + word1 + "\" to \"" + word2 + "\" are: ";
            else result = "The bridge words from \"" + word1 + "\" to \"" + word2 + "\" is: ";
    ...
    public void saveGraphImage(GraphPanel graphPanel, String filePath) throws IOException {
        graphPanel.saveGraphAsImage(new File(filePath));
    }
